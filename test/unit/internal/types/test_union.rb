...
describe Mailchimp::Internal::Types::Union do
  class Rectangle < Mailchimp::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Mailchimp::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Mailchimp::Internal::Types::Model
