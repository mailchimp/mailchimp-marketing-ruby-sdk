...
describe Mailchimp::Internal::Types::Utils do
  Utils = Mailchimp::Internal::Types::Utils

  module TestUtils
    class M < Mailchimp::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Mailchimp::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Mailchimp::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Mailchimp::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Mailchimp::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises Mailchimp::Internal::Errors::TypeError do
    ...
    describe "Array" do
      StringArray = Mailchimp::Internal::Types::Array[String]
      ModelArray = -> { Mailchimp::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Mailchimp::Internal::Types::Array[TestUtils::U] }
