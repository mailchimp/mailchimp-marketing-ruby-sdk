...
describe Mailchimp::Internal::Types::Model do
  ...
  class ExampleModel < Mailchimp::Internal::Types::Model
    field :name, String
  ...
  class ExampleWithBooleans < Mailchimp::Internal::Types::Model
    field :enabled, Mailchimp::Internal::Types::Boolean
    field :archived, Mailchimp::Internal::Types::Boolean, default: true
  end

  class ExampleWithFalseDefault < Mailchimp::Internal::Types::Model
    field :archived, Mailchimp::Internal::Types::Boolean, default: false
  end

  class ExampleChild < Mailchimp::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Mailchimp::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Mailchimp::Internal::Types::Model
