...
require_relative "lib/mailchimp/version"
...
Gem::Specification.new do |spec|
  spec.name = "mailchimp-marketing"
  spec.authors = ["Mailchimp"]
  spec.version = Mailchimp::VERSION
  spec.summary = "Ruby client library for the Mailchimp API"
  spec.description = "The Mailchimp Ruby library provides convenient access to the Mailchimp API from Ruby."
