...
module Mailchimp
  module SearchMembers
    module Types
      ...
      # performed.
      class ListSearchMembersResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::SearchMembers::Types::ListSearchMembersResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
