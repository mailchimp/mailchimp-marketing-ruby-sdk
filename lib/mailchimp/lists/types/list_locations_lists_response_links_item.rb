...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListLocationsListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListLocationsListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
