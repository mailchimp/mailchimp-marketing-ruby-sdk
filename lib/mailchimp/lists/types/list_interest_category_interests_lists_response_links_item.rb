...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListInterestCategoryInterestsListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListInterestCategoryInterestsListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
