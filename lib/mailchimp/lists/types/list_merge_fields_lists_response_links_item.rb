...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListMergeFieldsListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListMergeFieldsListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
