...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListMemberEventsListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListMemberEventsListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
