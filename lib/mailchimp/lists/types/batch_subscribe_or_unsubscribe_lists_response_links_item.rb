...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class BatchSubscribeOrUnsubscribeListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::BatchSubscribeOrUnsubscribeListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
