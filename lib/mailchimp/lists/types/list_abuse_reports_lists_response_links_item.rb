...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListAbuseReportsListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListAbuseReportsListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
