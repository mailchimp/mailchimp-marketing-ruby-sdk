...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListMemberActivityListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListMemberActivityListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
