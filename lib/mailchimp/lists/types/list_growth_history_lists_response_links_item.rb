...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListGrowthHistoryListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListGrowthHistoryListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
