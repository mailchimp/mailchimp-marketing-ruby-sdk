...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListClientsListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListClientsListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
