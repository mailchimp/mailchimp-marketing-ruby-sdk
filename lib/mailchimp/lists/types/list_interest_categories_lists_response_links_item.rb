...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListInterestCategoriesListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListInterestCategoriesListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
