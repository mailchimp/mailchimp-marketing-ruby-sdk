...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListMemberTagsListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListMemberTagsListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
