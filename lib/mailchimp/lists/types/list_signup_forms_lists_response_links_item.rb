...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListSignupFormsListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListSignupFormsListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
