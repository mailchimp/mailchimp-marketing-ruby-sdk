...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListSegmentsListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListSegmentsListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
