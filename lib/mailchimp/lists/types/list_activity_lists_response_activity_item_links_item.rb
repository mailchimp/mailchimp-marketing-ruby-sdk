...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListActivityListsResponseActivityItemLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListActivityListsResponseActivityItemLinksItemMethod }, optional: true, nullable: false, api_name: "method"
