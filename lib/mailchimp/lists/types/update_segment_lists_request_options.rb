...
module Mailchimp
  module Lists
    module Types
      ...
      class UpdateSegmentListsRequestOptions < Internal::Types::Model
        field :conditions, -> { Internal::Types::Array[Mailchimp::Types::SegmentTypeItem] }, optional: true, nullable: false

        field :match, -> { Mailchimp::Lists::Types::UpdateSegmentListsRequestOptionsMatch }, optional: true, nullable: false
      end
    end
  end
end
