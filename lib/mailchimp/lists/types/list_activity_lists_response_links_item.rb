...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListActivityListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListActivityListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
