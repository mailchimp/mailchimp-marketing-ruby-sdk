...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListMembersListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListMembersListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
