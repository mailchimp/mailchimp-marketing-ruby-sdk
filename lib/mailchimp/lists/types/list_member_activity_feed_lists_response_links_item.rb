...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListMemberActivityFeedListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListMemberActivityFeedListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
