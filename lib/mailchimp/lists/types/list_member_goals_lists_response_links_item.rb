...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListMemberGoalsListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListMemberGoalsListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
