...
module Mailchimp
  module Lists
    module Types
      ...
      # performed.
      class ListMemberNotesListsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Lists::Types::ListMemberNotesListsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
