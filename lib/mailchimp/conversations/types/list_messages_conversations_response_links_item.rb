...
module Mailchimp
  module Conversations
    module Types
      ...
      # performed.
      class ListMessagesConversationsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Conversations::Types::ListMessagesConversationsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
