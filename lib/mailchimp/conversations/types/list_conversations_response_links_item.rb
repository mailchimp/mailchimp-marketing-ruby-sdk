...
module Mailchimp
  module Conversations
    module Types
      ...
      # performed.
      class ListConversationsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Conversations::Types::ListConversationsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
