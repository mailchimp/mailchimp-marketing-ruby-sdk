...
module Mailchimp
  module Root
    module Types
      ...
      # performed.
      class ListRootResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Root::Types::ListRootResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
