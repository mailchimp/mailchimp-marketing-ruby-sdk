...
module Mailchimp
  module LandingPages
    module Types
      ...
      # performed.
      class ListLandingPagesResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::LandingPages::Types::ListLandingPagesResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
