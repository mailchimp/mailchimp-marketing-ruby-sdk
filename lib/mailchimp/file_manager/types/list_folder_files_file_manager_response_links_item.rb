...
module Mailchimp
  module FileManager
    module Types
      ...
      # performed.
      class ListFolderFilesFileManagerResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::FileManager::Types::ListFolderFilesFileManagerResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
