...
module Mailchimp
  module FileManager
    module Types
      ...
      # performed.
      class ListFoldersFileManagerResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::FileManager::Types::ListFoldersFileManagerResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
