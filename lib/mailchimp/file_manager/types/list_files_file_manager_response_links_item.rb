...
module Mailchimp
  module FileManager
    module Types
      ...
      # performed.
      class ListFilesFileManagerResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::FileManager::Types::ListFilesFileManagerResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
