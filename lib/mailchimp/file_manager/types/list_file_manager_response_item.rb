...
module Mailchimp
  module FileManager
    module Types
      ...
      # performed.
      class ListFileManagerResponseItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::FileManager::Types::ListFileManagerResponseItemMethod }, optional: true, nullable: false, api_name: "method"
