...
module Mailchimp
  module FileManager
    module Types
      ...
      # performed.
      class GetFolderFileManagerResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::FileManager::Types::GetFolderFileManagerResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
