...
module Mailchimp
  module FileManager
    module Types
      ...
      # performed.
      class UpdateFolderFileManagerResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::FileManager::Types::UpdateFolderFileManagerResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
