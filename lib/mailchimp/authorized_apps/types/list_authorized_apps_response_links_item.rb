...
module Mailchimp
  module AuthorizedApps
    module Types
      ...
      # performed.
      class ListAuthorizedAppsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::AuthorizedApps::Types::ListAuthorizedAppsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
