...
module Mailchimp
  module AuthorizedApps
    module Types
      ...
      # performed.
      class ListAuthorizedAppsResponseAppsItemLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::AuthorizedApps::Types::ListAuthorizedAppsResponseAppsItemLinksItemMethod }, optional: true, nullable: false, api_name: "method"
