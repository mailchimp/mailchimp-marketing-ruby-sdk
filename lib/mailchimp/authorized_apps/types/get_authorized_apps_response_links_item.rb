...
module Mailchimp
  module AuthorizedApps
    module Types
      ...
      # performed.
      class GetAuthorizedAppsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::AuthorizedApps::Types::GetAuthorizedAppsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
