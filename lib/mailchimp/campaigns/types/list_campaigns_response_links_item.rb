...
module Mailchimp
  module Campaigns
    module Types
      ...
      # performed.
      class ListCampaignsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Campaigns::Types::ListCampaignsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
