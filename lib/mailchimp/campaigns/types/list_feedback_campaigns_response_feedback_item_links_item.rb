...
module Mailchimp
  module Campaigns
    module Types
      ...
      # performed.
      class ListFeedbackCampaignsResponseFeedbackItemLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Campaigns::Types::ListFeedbackCampaignsResponseFeedbackItemLinksItemMethod }, optional: true, nullable: false, api_name: "method"
