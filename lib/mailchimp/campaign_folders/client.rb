  ...
  module CampaignFolders
    class Client
      ...
      def list(request_options: {}, **params)
        ...
        Mailchimp::Internal::OffsetItemIterator.new(
          ...
          if code.between?(200, 299)
            parsed_response = Mailchimp::Types::CampaignFolders.load(response.body)
      ...
      def create(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          Mailchimp::Types::CampaignFolders.load(response.body)
        else
          error_class = Mailchimp::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      def get(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          Mailchimp::CampaignFolders::Types::GetCampaignFoldersResponse.load(response.body)
        else
          error_class = Mailchimp::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      def update(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          Mailchimp::CampaignFolders::Types::UpdateCampaignFoldersResponse.load(response.body)
        else
          error_class = Mailchimp::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
