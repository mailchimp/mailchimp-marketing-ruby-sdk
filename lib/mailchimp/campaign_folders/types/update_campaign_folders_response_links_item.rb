...
module Mailchimp
  module CampaignFolders
    module Types
      ...
      # performed.
      class UpdateCampaignFoldersResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::CampaignFolders::Types::UpdateCampaignFoldersResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
