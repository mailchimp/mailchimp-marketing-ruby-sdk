...
module Mailchimp
  module CampaignFolders
    module Types
      ...
      # performed.
      class GetCampaignFoldersResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::CampaignFolders::Types::GetCampaignFoldersResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
