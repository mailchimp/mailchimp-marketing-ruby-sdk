...
module Mailchimp
  module ActivityFeed
    module Types
      ...
      # performed.
      class ListChimpChatterActivityFeedResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::ActivityFeed::Types::ListChimpChatterActivityFeedResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
