...
module Mailchimp
  module ActivityFeed
    class Client
      ...
      #
      # @return [Array[Mailchimp::ActivityFeed::Types::ListActivityFeedResponseItem]]
      ...
      #
      # @return [Mailchimp::ActivityFeed::Types::ListChimpChatterActivityFeedResponse]
      def list_chimp_chatter(request_options: {}, **params)
