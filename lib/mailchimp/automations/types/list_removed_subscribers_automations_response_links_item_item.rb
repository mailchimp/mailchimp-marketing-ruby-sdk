...
module Mailchimp
  module Automations
    module Types
      ...
      # performed.
      class ListRemovedSubscribersAutomationsResponseLinksItemItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Automations::Types::ListRemovedSubscribersAutomationsResponseLinksItemItemMethod }, optional: true, nullable: false, api_name: "method"
