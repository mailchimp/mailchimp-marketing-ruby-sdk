...
module Mailchimp
  module Automations
    module Types
      ...
      # performed.
      class ListEmailQueueAutomationsResponseQueueItemLinksItemItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Automations::Types::ListEmailQueueAutomationsResponseQueueItemLinksItemItemMethod }, optional: true, nullable: false, api_name: "method"
