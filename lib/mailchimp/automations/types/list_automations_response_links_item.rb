...
module Mailchimp
  module Automations
    module Types
      ...
      # performed.
      class ListAutomationsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Automations::Types::ListAutomationsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
