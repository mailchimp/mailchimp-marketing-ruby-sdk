...
module Mailchimp
  module Automations
    module Types
      ...
      # performed.
      class ListEmailQueueAutomationsResponseLinksItemItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Automations::Types::ListEmailQueueAutomationsResponseLinksItemItemMethod }, optional: true, nullable: false, api_name: "method"
