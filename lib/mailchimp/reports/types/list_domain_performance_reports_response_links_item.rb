...
module Mailchimp
  module Reports
    module Types
      ...
      # performed.
      class ListDomainPerformanceReportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reports::Types::ListDomainPerformanceReportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
