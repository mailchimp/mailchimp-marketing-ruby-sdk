...
module Mailchimp
  module Reports
    module Types
      ...
      # performed.
      class ListEmailActivityReportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reports::Types::ListEmailActivityReportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
