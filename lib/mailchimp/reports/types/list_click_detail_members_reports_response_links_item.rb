...
module Mailchimp
  module Reports
    module Types
      ...
      # performed.
      class ListClickDetailMembersReportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reports::Types::ListClickDetailMembersReportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
