...
module Mailchimp
  module Reports
    module Types
      ...
      # performed.
      class ListUnsubscribedReportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reports::Types::ListUnsubscribedReportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
