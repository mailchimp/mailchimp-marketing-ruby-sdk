...
module Mailchimp
  module Reports
    module Types
      ...
      # performed.
      class ListLocationsReportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reports::Types::ListLocationsReportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
