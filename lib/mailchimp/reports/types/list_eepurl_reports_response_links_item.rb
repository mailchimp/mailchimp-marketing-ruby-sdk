...
module Mailchimp
  module Reports
    module Types
      ...
      # performed.
      class ListEepurlReportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reports::Types::ListEepurlReportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
