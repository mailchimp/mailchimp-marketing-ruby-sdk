...
module Mailchimp
  module Reports
    module Types
      ...
      # performed.
      class ListAbuseReportsReportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reports::Types::ListAbuseReportsReportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
