...
module Mailchimp
  module Reports
    module Types
      ...
      # performed.
      class ListAdviceReportsResponseAdviceItemLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reports::Types::ListAdviceReportsResponseAdviceItemLinksItemMethod }, optional: true, nullable: false, api_name: "method"
