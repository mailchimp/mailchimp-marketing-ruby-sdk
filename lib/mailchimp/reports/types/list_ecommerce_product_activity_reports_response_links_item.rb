...
module Mailchimp
  module Reports
    module Types
      ...
      # performed.
      class ListEcommerceProductActivityReportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reports::Types::ListEcommerceProductActivityReportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
