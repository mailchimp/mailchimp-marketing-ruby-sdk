...
module Mailchimp
  module Reports
    module Types
      ...
      # performed.
      class ListSubReportsReportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reports::Types::ListSubReportsReportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
