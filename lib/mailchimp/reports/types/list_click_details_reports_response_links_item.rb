...
module Mailchimp
  module Reports
    module Types
      ...
      # performed.
      class ListClickDetailsReportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reports::Types::ListClickDetailsReportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
