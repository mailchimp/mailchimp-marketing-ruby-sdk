...
module Mailchimp
  module Reports
    module Types
      ...
      # performed.
      class ListOpenDetailsReportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reports::Types::ListOpenDetailsReportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
