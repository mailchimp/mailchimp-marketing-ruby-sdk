...
module Mailchimp
  module Reports
    module Types
      ...
      # performed.
      class ListReportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reports::Types::ListReportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
