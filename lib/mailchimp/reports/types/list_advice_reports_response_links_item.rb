...
module Mailchimp
  module Reports
    module Types
      ...
      # performed.
      class ListAdviceReportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reports::Types::ListAdviceReportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
