...
module Mailchimp
  module Reports
    module Types
      ...
      # performed.
      class ListSentToReportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reports::Types::ListSentToReportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
