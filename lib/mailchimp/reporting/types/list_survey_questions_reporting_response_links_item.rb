...
module Mailchimp
  module Reporting
    module Types
      ...
      # performed.
      class ListSurveyQuestionsReportingResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reporting::Types::ListSurveyQuestionsReportingResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
