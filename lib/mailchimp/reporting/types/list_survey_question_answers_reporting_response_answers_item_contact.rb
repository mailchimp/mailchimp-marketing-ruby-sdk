...
module Mailchimp
  module Reporting
    module Types
      ...
      class ListSurveyQuestionAnswersReportingResponseAnswersItemContact < Internal::Types::Model
        ...
        field :status, -> { Mailchimp::Reporting::Types::ListSurveyQuestionAnswersReportingResponseAnswersItemContactStatus }, optional: true, nullable: false
      end
    end
  end
end
