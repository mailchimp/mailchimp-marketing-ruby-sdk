...
module Mailchimp
  module Reporting
    module Types
      ...
      # performed.
      class ListSurveyQuestionAnswersReportingResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reporting::Types::ListSurveyQuestionAnswersReportingResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
