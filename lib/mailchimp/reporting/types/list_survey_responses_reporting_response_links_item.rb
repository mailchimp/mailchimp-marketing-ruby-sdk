...
module Mailchimp
  module Reporting
    module Types
      ...
      # performed.
      class ListSurveyResponsesReportingResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reporting::Types::ListSurveyResponsesReportingResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
