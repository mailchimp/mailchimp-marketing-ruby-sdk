...
module Mailchimp
  module Reporting
    module Types
      ...
      # performed.
      class ListFacebookAdsReportingResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reporting::Types::ListFacebookAdsReportingResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
