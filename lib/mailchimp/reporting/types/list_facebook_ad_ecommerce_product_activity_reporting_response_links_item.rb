...
module Mailchimp
  module Reporting
    module Types
      ...
      # performed.
      class ListFacebookAdEcommerceProductActivityReportingResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reporting::Types::ListFacebookAdEcommerceProductActivityReportingResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
