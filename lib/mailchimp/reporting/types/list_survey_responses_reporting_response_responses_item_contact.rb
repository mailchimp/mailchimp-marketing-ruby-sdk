...
module Mailchimp
  module Reporting
    module Types
      ...
      class ListSurveyResponsesReportingResponseResponsesItemContact < Internal::Types::Model
        ...
        field :status, -> { Mailchimp::Reporting::Types::ListSurveyResponsesReportingResponseResponsesItemContactStatus }, optional: true, nullable: false
      end
    end
  end
end
