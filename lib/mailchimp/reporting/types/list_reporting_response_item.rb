...
module Mailchimp
  module Reporting
    module Types
      ...
      # performed.
      class ListReportingResponseItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reporting::Types::ListReportingResponseItemMethod }, optional: true, nullable: false, api_name: "method"
