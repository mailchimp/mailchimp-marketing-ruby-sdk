...
module Mailchimp
  module Reporting
    module Types
      ...
      # performed.
      class ListLandingPagesReportingResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Reporting::Types::ListLandingPagesReportingResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
