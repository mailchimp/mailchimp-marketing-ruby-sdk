...
module Mailchimp
  module FacebookAds
    module Types
      ...
      # performed.
      class ListFacebookAdsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::FacebookAds::Types::ListFacebookAdsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
