...
module Mailchimp
  module VerifiedDomains
    module Types
      ...
      class CreateVerifiedDomainsResponse < Internal::Types::Model
        ...
        field :status, -> { Mailchimp::VerifiedDomains::Types::CreateVerifiedDomainsResponseStatus }, optional: true, nullable: false
