...
module Mailchimp
  module VerifiedDomains
    module Types
      ...
      class CreateActionVerifyVerifiedDomainsResponse < Internal::Types::Model
        ...
        field :status, -> { Mailchimp::VerifiedDomains::Types::CreateActionVerifyVerifiedDomainsResponseStatus }, optional: true, nullable: false
