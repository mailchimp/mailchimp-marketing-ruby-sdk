...
module Mailchimp
  module VerifiedDomains
    module Types
      ...
      class ListVerifiedDomainsResponseDomainsItem < Internal::Types::Model
        ...
        field :status, -> { Mailchimp::VerifiedDomains::Types::ListVerifiedDomainsResponseDomainsItemStatus }, optional: true, nullable: false
