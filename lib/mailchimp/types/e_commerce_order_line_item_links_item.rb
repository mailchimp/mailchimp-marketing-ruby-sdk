...
module Mailchimp
  module Types
    ...
    # performed.
    class ECommerceOrderLineItemLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ECommerceOrderLineItemLinksItemMethod }, optional: true, nullable: false, api_name: "method"
