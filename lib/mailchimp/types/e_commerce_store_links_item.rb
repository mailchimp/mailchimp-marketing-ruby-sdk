...
module Mailchimp
  module Types
    ...
    # performed.
    class ECommerceStoreLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ECommerceStoreLinksItemMethod }, optional: true, nullable: false, api_name: "method"
