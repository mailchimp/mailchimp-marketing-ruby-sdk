...
module Mailchimp
  module Types
    ...
    # performed.
    class AutomationWorkflowEmailLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::AutomationWorkflowEmailLinksItemMethod }, optional: true, nullable: false, api_name: "method"
