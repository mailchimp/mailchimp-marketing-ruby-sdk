...
module Mailchimp
  module Types
    ...
    # performed.
    class ECommercePromoCodeLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ECommercePromoCodeLinksItemMethod }, optional: true, nullable: false, api_name: "method"
