...
module Mailchimp
  module Types
    ...
    # performed.
    class ClickDetailReportLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ClickDetailReportLinksItemMethod }, optional: true, nullable: false, api_name: "method"
