...
module Mailchimp
  module Types
    ...
    # performed.
    class SubscriberListLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::SubscriberListLinksItemMethod }, optional: true, nullable: false, api_name: "method"
