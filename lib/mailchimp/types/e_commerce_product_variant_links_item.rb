...
module Mailchimp
  module Types
    ...
    # performed.
    class ECommerceProductVariantLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ECommerceProductVariantLinksItemMethod }, optional: true, nullable: false, api_name: "method"
