...
module Mailchimp
  module Types
    ...
    # performed.
    class EmailActivityLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::EmailActivityLinksItemMethod }, optional: true, nullable: false, api_name: "method"
