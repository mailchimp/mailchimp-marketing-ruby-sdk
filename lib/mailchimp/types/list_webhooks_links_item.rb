...
module Mailchimp
  module Types
    ...
    # performed.
    class ListWebhooksLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ListWebhooksLinksItemMethod }, optional: true, nullable: false, api_name: "method"
