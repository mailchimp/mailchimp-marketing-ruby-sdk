...
module Mailchimp
  module Types
    ...
    # performed.
    class ClickDetailMemberLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ClickDetailMemberLinksItemMethod }, optional: true, nullable: false, api_name: "method"
