...
module Mailchimp
  module Types
    ...
    # performed.
    class ReportingFacebookAdLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ReportingFacebookAdLinksItemMethod }, optional: true, nullable: false, api_name: "method"
