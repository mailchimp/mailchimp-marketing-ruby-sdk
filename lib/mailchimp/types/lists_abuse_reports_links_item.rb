...
module Mailchimp
  module Types
    ...
    # performed.
    class ListsAbuseReportsLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ListsAbuseReportsLinksItemMethod }, optional: true, nullable: false, api_name: "method"
