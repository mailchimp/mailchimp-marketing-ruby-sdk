...
module Mailchimp
  module Types
    ...
    # performed.
    class GrowthHistoryLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::GrowthHistoryLinksItemMethod }, optional: true, nullable: false, api_name: "method"
