...
module Mailchimp
  module Types
    ...
    # performed.
    class SubscriberRemovedFromAutomationWorkflowLinksItemItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::SubscriberRemovedFromAutomationWorkflowLinksItemItemMethod }, optional: true, nullable: false, api_name: "method"
