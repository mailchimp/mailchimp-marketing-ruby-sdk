...
module Mailchimp
  module Types
    ...
    # performed.
    class UnsubscribesLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::UnsubscribesLinksItemMethod }, optional: true, nullable: false, api_name: "method"
