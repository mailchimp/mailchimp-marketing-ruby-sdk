...
module Mailchimp
  module Types
    ...
    # performed.
    class ECommerceCartLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ECommerceCartLinksItemMethod }, optional: true, nullable: false, api_name: "method"
