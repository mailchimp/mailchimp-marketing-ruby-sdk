...
module Mailchimp
  module Types
    ...
    # performed.
    class TemplateInstanceLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::TemplateInstanceLinksItemMethod }, optional: true, nullable: false, api_name: "method"
