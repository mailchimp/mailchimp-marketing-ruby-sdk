...
module Mailchimp
  module Types
    ...
    # performed.
    class CampaignFoldersLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::CampaignFoldersLinksItemMethod }, optional: true, nullable: false, api_name: "method"
