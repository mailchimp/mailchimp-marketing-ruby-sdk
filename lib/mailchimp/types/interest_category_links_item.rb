...
module Mailchimp
  module Types
    ...
    # performed.
    class InterestCategoryLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::InterestCategoryLinksItemMethod }, optional: true, nullable: false, api_name: "method"
