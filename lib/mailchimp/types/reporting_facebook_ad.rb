...
module Mailchimp
  module Types
    class ReportingFacebookAd < Internal::Types::Model
      ...
      field :audience, -> { Mailchimp::Types::ReportingFacebookAdAudience }, optional: true, nullable: false

      field :audience_activity, -> { Mailchimp::Types::ReportingFacebookAdAudienceActivity }, optional: true, nullable: false

      field :budget, -> { Mailchimp::Types::ReportingFacebookAdBudget }, optional: true, nullable: false

      field :channel, -> { Mailchimp::Types::ReportingFacebookAdChannel }, optional: true, nullable: false

      field :report_summary, -> { Mailchimp::Types::ReportingFacebookAdReportSummary }, optional: true, nullable: false

      field :links, -> { Internal::Types::Array[Mailchimp::Types::ReportingFacebookAdLinksItem] }, optional: true, nullable: false, api_name: "_links"
