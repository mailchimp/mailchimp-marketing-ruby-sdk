...
module Mailchimp
  module Types
    # [Contact information displayed in campaign footers](https://mailchimp.com/help/about-campaign-footers/) to comply
    # with international spam laws.
    class SubscriberListContact < Internal::Types::Model
