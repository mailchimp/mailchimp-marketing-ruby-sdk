...
module Mailchimp
  module Types
    ...
    # performed.
    class SmsCampaignContentLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::SmsCampaignContentLinksItemMethod }, optional: true, nullable: false, api_name: "method"
