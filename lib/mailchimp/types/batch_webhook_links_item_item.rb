...
module Mailchimp
  module Types
    ...
    # performed.
    class BatchWebhookLinksItemItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::BatchWebhookLinksItemItemMethod }, optional: true, nullable: false, api_name: "method"
