...
module Mailchimp
  module Types
    ...
    # performed.
    class CampaignReportLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::CampaignReportLinksItemMethod }, optional: true, nullable: false, api_name: "method"
