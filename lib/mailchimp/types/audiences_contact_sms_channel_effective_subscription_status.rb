...
module Mailchimp
  module Types
    ...
    # values.
    class AudiencesContactSmsChannelEffectiveSubscriptionStatus < Internal::Types::Model
      field :value, -> { Mailchimp::Types::AudiencesContactSmsChannelEffectiveSubscriptionStatusValue }, optional: true, nullable: false
    end
  end
end
