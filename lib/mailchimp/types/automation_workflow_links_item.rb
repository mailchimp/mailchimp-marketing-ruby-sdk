...
module Mailchimp
  module Types
    ...
    # performed.
    class AutomationWorkflowLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::AutomationWorkflowLinksItemMethod }, optional: true, nullable: false, api_name: "method"
