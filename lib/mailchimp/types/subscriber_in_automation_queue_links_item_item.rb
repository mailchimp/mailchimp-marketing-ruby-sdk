...
module Mailchimp
  module Types
    ...
    # performed.
    class SubscriberInAutomationQueueLinksItemItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::SubscriberInAutomationQueueLinksItemItemMethod }, optional: true, nullable: false, api_name: "method"
