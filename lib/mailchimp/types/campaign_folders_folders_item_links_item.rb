...
module Mailchimp
  module Types
    ...
    # performed.
    class CampaignFoldersFoldersItemLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::CampaignFoldersFoldersItemLinksItemMethod }, optional: true, nullable: false, api_name: "method"
