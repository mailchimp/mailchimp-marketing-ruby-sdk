...
module Mailchimp
  module Types
    ...
    class FacebookAdRecipientsSegmentOpts < Internal::Types::Model
      field :conditions, -> { Internal::Types::Array[Mailchimp::Types::SegmentTypeItem] }, optional: true, nullable: false

      field :match, -> { Mailchimp::Types::FacebookAdRecipientsSegmentOptsMatch }, optional: true, nullable: false

      field :prebuilt_segment_id, -> { String }, optional: true, nullable: false

      field :saved_segment_id, -> { Mailchimp::Types::FacebookAdRecipientsSegmentOptsSavedSegmentID }, optional: true, nullable: false
    end
  end
end
