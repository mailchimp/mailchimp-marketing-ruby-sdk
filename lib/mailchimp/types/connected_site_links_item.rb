...
module Mailchimp
  module Types
    ...
    # performed.
    class ConnectedSiteLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ConnectedSiteLinksItemMethod }, optional: true, nullable: false, api_name: "method"
