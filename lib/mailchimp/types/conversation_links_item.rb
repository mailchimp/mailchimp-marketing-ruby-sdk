...
module Mailchimp
  module Types
    ...
    # performed.
    class ConversationLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ConversationLinksItemMethod }, optional: true, nullable: false, api_name: "method"
