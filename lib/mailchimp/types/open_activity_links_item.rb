...
module Mailchimp
  module Types
    ...
    # performed.
    class OpenActivityLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::OpenActivityLinksItemMethod }, optional: true, nullable: false, api_name: "method"
