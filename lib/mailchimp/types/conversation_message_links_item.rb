...
module Mailchimp
  module Types
    ...
    # performed.
    class ConversationMessageLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ConversationMessageLinksItemMethod }, optional: true, nullable: false, api_name: "method"
