...
module Mailchimp
  module Types
    ...
    # performed.
    class CampaignContentLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::CampaignContentLinksItemMethod }, optional: true, nullable: false, api_name: "method"
