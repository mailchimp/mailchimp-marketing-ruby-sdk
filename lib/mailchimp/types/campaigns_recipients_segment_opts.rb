...
module Mailchimp
  module Types
    ...
    class CampaignsRecipientsSegmentOpts < Internal::Types::Model
      field :conditions, -> { Internal::Types::Array[Mailchimp::Types::SegmentTypeItem] }, optional: true, nullable: false

      field :match, -> { Mailchimp::Types::CampaignsRecipientsSegmentOptsMatch }, optional: true, nullable: false

      field :prebuilt_segment_id, -> { String }, optional: true, nullable: false

      field :saved_segment_id, -> { Mailchimp::Types::CampaignsRecipientsSegmentOptsSavedSegmentID }, optional: true, nullable: false
    end
  end
end
