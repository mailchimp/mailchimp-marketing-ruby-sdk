...
module Mailchimp
  module Types
    ...
    # performed.
    class ECommerceProductImagesItemLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ECommerceProductImagesItemLinksItemMethod }, optional: true, nullable: false, api_name: "method"
