...
module Mailchimp
  module Types
    ...
    # performed.
    class ListsSegmentsMembersLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ListsSegmentsMembersLinksItemMethod }, optional: true, nullable: false, api_name: "method"
