...
module Mailchimp
  module Types
    ...
    # performed.
    class ECommerceCartLineItemLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ECommerceCartLineItemLinksItemMethod }, optional: true, nullable: false, api_name: "method"
