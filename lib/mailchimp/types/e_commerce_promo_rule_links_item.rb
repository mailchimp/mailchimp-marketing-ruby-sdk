...
module Mailchimp
  module Types
    ...
    # performed.
    class ECommercePromoRuleLinksItem < Internal::Types::Model
      field :href, -> { String }, optional: true, nullable: false

      field :method_, -> { Mailchimp::Types::ECommercePromoRuleLinksItemMethod }, optional: true, nullable: false, api_name: "method"
