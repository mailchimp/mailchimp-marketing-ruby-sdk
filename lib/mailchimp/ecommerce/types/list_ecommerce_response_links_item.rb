...
module Mailchimp
  module Ecommerce
    module Types
      ...
      # performed.
      class ListEcommerceResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Ecommerce::Types::ListEcommerceResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
