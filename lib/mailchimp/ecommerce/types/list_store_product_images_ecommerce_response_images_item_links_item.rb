...
module Mailchimp
  module Ecommerce
    module Types
      ...
      # performed.
      class ListStoreProductImagesEcommerceResponseImagesItemLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Ecommerce::Types::ListStoreProductImagesEcommerceResponseImagesItemLinksItemMethod }, optional: true, nullable: false, api_name: "method"
