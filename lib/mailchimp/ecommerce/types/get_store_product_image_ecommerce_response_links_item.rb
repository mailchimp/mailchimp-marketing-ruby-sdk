...
module Mailchimp
  module Ecommerce
    module Types
      ...
      # performed.
      class GetStoreProductImageEcommerceResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Ecommerce::Types::GetStoreProductImageEcommerceResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
