...
module Mailchimp
  module Ecommerce
    module Types
      ...
      # performed.
      class ListOrdersEcommerceResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Ecommerce::Types::ListOrdersEcommerceResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
