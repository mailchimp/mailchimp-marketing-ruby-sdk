...
module Mailchimp
  module Ecommerce
    module Types
      ...
      # performed.
      class ListStorePromoRulesEcommerceResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Ecommerce::Types::ListStorePromoRulesEcommerceResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
