...
module Mailchimp
  module Ecommerce
    module Types
      ...
      # performed.
      class ListStoreOrderLinesEcommerceResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Ecommerce::Types::ListStoreOrderLinesEcommerceResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
