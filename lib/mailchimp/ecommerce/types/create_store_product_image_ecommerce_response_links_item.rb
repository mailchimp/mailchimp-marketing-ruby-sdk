...
module Mailchimp
  module Ecommerce
    module Types
      ...
      # performed.
      class CreateStoreProductImageEcommerceResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Ecommerce::Types::CreateStoreProductImageEcommerceResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
