...
module Mailchimp
  module Ecommerce
    module Types
      ...
      # performed.
      class ListStorePromoRulePromoCodesEcommerceResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Ecommerce::Types::ListStorePromoRulePromoCodesEcommerceResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
