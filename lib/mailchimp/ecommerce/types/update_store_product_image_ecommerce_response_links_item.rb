...
module Mailchimp
  module Ecommerce
    module Types
      ...
      # performed.
      class UpdateStoreProductImageEcommerceResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Ecommerce::Types::UpdateStoreProductImageEcommerceResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
