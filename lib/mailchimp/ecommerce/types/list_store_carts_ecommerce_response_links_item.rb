...
module Mailchimp
  module Ecommerce
    module Types
      ...
      # performed.
      class ListStoreCartsEcommerceResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Ecommerce::Types::ListStoreCartsEcommerceResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
