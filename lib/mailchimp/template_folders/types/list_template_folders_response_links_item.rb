...
module Mailchimp
  module TemplateFolders
    module Types
      ...
      # performed.
      class ListTemplateFoldersResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::TemplateFolders::Types::ListTemplateFoldersResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
