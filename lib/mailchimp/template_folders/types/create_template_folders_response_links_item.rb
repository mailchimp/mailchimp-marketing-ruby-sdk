...
module Mailchimp
  module TemplateFolders
    module Types
      ...
      # performed.
      class CreateTemplateFoldersResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::TemplateFolders::Types::CreateTemplateFoldersResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
