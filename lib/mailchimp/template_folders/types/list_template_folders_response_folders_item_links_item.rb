...
module Mailchimp
  module TemplateFolders
    module Types
      ...
      # performed.
      class ListTemplateFoldersResponseFoldersItemLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::TemplateFolders::Types::ListTemplateFoldersResponseFoldersItemLinksItemMethod }, optional: true, nullable: false, api_name: "method"
