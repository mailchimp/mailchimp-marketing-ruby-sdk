...
module Mailchimp
  module TemplateFolders
    module Types
      ...
      # performed.
      class GetTemplateFoldersResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::TemplateFolders::Types::GetTemplateFoldersResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
