...
module Mailchimp
  module Batches
    module Types
      ...
      # performed.
      class ListBatchesResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Batches::Types::ListBatchesResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
