...
module Mailchimp
  module Templates
    module Types
      ...
      # performed.
      class ListDefaultContentTemplatesResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::Templates::Types::ListDefaultContentTemplatesResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
