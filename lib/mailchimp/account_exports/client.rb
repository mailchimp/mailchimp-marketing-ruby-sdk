...
module Mailchimp
  module AccountExports
    class Client
      ...
      #
      # @return [Mailchimp::AccountExports::Types::ListAccountExportsResponse]
      def list(request_options: {}, **params)
        ...
        Mailchimp::Internal::OffsetItemIterator.new(
          ...
          if code.between?(200, 299)
            parsed_response = (response.body.to_s.empty? ? nil : Mailchimp::AccountExports::Types::ListAccountExportsResponse.load(response.body))
      ...
      #
      # @param request_options [Hash]
      # @param params [Mailchimp::AccountExports::Types::CreateAccountExportsRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      #
      # @return [Mailchimp::AccountExports::Types::CreateAccountExportsResponse]
      def create(request_options: {}, **params)
        ...
        request = Mailchimp::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "3.0/account-exports",
          body: Mailchimp::AccountExports::Types::CreateAccountExportsRequest.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : Mailchimp::AccountExports::Types::CreateAccountExportsResponse.load(response.body))
        else
          error_class = Mailchimp::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [Mailchimp::AccountExports::Types::GetAccountExportsResponse]
      def get(request_options: {}, **params)
        ...
        request = Mailchimp::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "GET",
          path: "3.0/account-exports/#{URI.encode_uri_component(params[:export_id].to_s)}",
          query: query_params,
          request_options: request_options
        )
        begin
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : Mailchimp::AccountExports::Types::GetAccountExportsResponse.load(response.body))
        else
          error_class = Mailchimp::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
