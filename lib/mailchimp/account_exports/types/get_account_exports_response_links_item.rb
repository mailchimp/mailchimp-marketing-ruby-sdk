...
module Mailchimp
  module AccountExports
    module Types
      ...
      # performed.
      class GetAccountExportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::AccountExports::Types::GetAccountExportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
