...
module Mailchimp
  module AccountExports
    module Types
      ...
      # performed.
      class CreateAccountExportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::AccountExports::Types::CreateAccountExportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
