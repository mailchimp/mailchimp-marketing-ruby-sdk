...
module Mailchimp
  module AccountExports
    module Types
      ...
      # performed.
      class ListAccountExportsResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::AccountExports::Types::ListAccountExportsResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
