...
module Mailchimp
  module AccountExports
    module Types
      ...
      # performed.
      class ListAccountExportsResponseExportsItemLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::AccountExports::Types::ListAccountExportsResponseExportsItemLinksItemMethod }, optional: true, nullable: false, api_name: "method"
