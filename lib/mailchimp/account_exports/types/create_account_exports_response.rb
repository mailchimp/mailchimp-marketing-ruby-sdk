...
module Mailchimp
  module AccountExports
    module Types
      # An account export.
      class CreateAccountExportsResponse < Internal::Types::Model
        field :links, -> { Internal::Types::Array[Mailchimp::AccountExports::Types::CreateAccountExportsResponseLinksItem] }, optional: true, nullable: false, api_name: "_links"
