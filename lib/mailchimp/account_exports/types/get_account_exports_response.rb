...
module Mailchimp
  module AccountExports
    module Types
      # An account export.
      class GetAccountExportsResponse < Internal::Types::Model
        field :links, -> { Internal::Types::Array[Mailchimp::AccountExports::Types::GetAccountExportsResponseLinksItem] }, optional: true, nullable: false, api_name: "_links"
