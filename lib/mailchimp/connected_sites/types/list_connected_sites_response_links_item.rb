...
module Mailchimp
  module ConnectedSites
    module Types
      ...
      # performed.
      class ListConnectedSitesResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::ConnectedSites::Types::ListConnectedSitesResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
