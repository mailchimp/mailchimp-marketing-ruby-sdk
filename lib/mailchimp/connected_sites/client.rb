...
module Mailchimp
  module ConnectedSites
    class Client
      ...
      #
      # @return [Mailchimp::ConnectedSites::Types::ListConnectedSitesResponse]
      ...
      #
      # @param request_options [Hash]
      # @param params [Mailchimp::ConnectedSites::Types::CreateConnectedSitesRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      #   )
      #
      # @return [Mailchimp::Types::ConnectedSite]
      def create(request_options: {}, **params)
        ...
        request = Mailchimp::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "3.0/connected-sites",
          body: Mailchimp::ConnectedSites::Types::CreateConnectedSitesRequest.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      # @option request_options [Integer] :timeout_in_seconds
      # @option params [String] :connected_site_id
      # @option params [String, nil] :fields
      # @option params [String, nil] :exclude_fields
      #
      # @example
      ...
      def get(request_options: {}, **params)
        ...
        request = Mailchimp::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "GET",
          path: "3.0/connected-sites/#{URI.encode_uri_component(params[:connected_site_id].to_s)}",
          query: query_params,
          request_options: request_options
        )
        begin
      ...
      #
      # @return [untyped]
      def create_action_verify_script_installation(request_options: {}, **params)
        params = Mailchimp::Internal::Types::Utils.normalize_keys(params)
        request = Mailchimp::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
          path: "3.0/connected-sites/#{URI.encode_uri_component(params[:connected_site_id].to_s)}/actions/verify-script-installation",
          request_options: request_options
        )
        begin
          response = @client.send(request)
