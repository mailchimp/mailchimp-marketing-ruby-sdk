...
module Mailchimp
  module BatchWebhooks
    module Types
      ...
      # performed.
      class ListBatchWebhooksResponseLinksItem < Internal::Types::Model
        field :href, -> { String }, optional: true, nullable: false

        field :method_, -> { Mailchimp::BatchWebhooks::Types::ListBatchWebhooksResponseLinksItemMethod }, optional: true, nullable: false, api_name: "method"
