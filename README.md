# Mailchimp Ruby Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=https%3A%2F%2Fgithub.com%2Fmailchimp%2Fmailchimp-marketing-ruby-sdk)

The Mailchimp Ruby library provides convenient access to the Mailchimp APIs from Ruby.
...
A full reference for this library is available [here](https://github.com/mailchimp/mailchimp-marketing-ruby-sdk/blob/HEAD/./reference.md).
...
client = Mailchimp::Client.new(token: "<token>")
...
mailchimp = Mailchimp::Client.new(
    base_url: Mailchimp::Environment::DEFAULT
)
```
...
begin
    result = client.account_exports.create
rescue Mailchimp::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue Mailchimp::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue Mailchimp::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue Mailchimp::Errors::ResponseError => e
